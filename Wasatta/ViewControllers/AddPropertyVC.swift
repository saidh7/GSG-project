...
class AddPropertyVC: UIViewController, FlexibleSteppedProgressBarDelegate,UIImagePickerControllerDelegate , UINavigationControllerDelegate, GMSMapViewDelegate {
    let appDelegate = UIApplication.shared.delegate as! AppDelegate

    let loginVc = SignInViewController()
    let languageVC = TestLocaVC()
    
    let radiobtns = SKRadioButton()
...
//        view.addGestureRecognizer(tapRecognizer)
    ...
    @objc func setText(){
        ...
        self.navItem.title = "Add property".localized();
    ...
    @IBAction func btn_finish_Pressed(_ sender: Any) {
       ...
       SVProgressHUD.show()
        ...
        let url = "https://www.wasataa.com/api/RealEstate/AddRealEstate"
...
//                        self.view.makeToast("Your properity is successfully added!")
...
extension AddPropertyVC:UICollectionViewDataSource, UICollectionViewDelegate{
...
extension AddPropertyVC : ImageCollectionCellDelegate{
...
//                        self.setupCoutryDrop()
    ...
    func setupCurrencyDrop() {
        ...
        self.parameters["priceType"] = self.Arr_priceCurrency[0]["id"].stringValue
        self.btn_priceCurrency.setTitle(BranchNames[0], for: .normal)
    ...
    func setupSpaceUnitDrop() {
        ...
        self.parameters["unitArea"] = self.Arr_spaceUnit[0]["id"].stringValue
        self.btn_spaceUnit.setTitle(BranchNames[0], for: .normal)
...
//
//           }
//           self.parameters["BuildAge"] = self.Arr_Property[0]["id"].stringValue
...
//    new
    ...
    //
    //    drop_chosePropertyType.selectionAction = { [weak self] (index, item) in
    //        self?.parameters["PropertyType"] = self?.Arr_Property[safe: index]?["id"].stringValue
    //        self?.btn_Property_Sub.setTitle(item, for: .normal)
    //
    //    }
    //
    ...
    func setupBuildingDrop() {
        ...
        self.btn_Building.setTitle(BranchNames[0], for: .normal)
    ...
    func setupfloorDrop() {
        ...
        drop_choseFloors.selectionAction = { [weak self] (index, item) in
            self?.parameters["FloorsNumber"] = self?.Arr_floor[index]["id"].stringValue
    ...
    func setupCurrentFloorDrop() {
        ...
        drop_choseCurrentFloor.selectionAction = { [weak self] (index, item) in
            self?.parameters["Floor"] = self?.Arr_CurrentFloor[index]["id"].stringValue
    ...
    func setupDistributionDrop() {
        ...
        self.parameters["HeatingDistribution"] = self.Arr_heatingDistribution[0]["id"].stringValue
        self.btn_heating_Distrbution.setTitle(BranchNames[0], for: .normal)
...
extension  AddPropertyVC : CLLocationManagerDelegate {
...
//
//extension AddPropertyVC: GMSMapViewDelegate {
//
...
extension Notification.Name {
    static let openmyproperty = Notification.Name("openmyproperty")
